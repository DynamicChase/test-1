    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Hire Freelancers</CardTitle>
          <CardDescription>Sign in to find and hire talented professionals</CardDescription>
        </CardHeader>
      ...
      <div className="fixed bottom-4 right-4 p-4 bg-muted rounded-lg max-w-xs text-sm">
        ...
        <p className="text-xs text-muted-foreground">Email: buyer@example.com</p>
        <p className="text-xs text-muted-foreground">Password: buyer123</p>
      </div>
    </div>
  );
}
